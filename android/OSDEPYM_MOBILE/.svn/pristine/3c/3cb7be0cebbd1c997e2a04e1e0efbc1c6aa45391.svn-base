...
public class PrestadorActivity extends AbstractActivity {
	...
	private boolean estaExpandidoTextoEspecialidades = false;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		textEspecialidad = (TextView) findViewById(R.id.textEspecialidadPrestador);
		textEspecialidad.setText(prestador.getEspecialidad());
		findViewById(R.id.ver_mas).setOnClickListener(expandirOColapsarTexto);
		findViewById(R.id.ocultar).setOnClickListener(expandirOColapsarTexto);
	...
	private OnClickListener expandirOColapsarTexto = new OnClickListener() {
		
		@Override
		public void onClick(View v) {
			
			textEspecialidad.setSingleLine(estaExpandidoTextoEspecialidades);
			estaExpandidoTextoEspecialidades = !estaExpandidoTextoEspecialidades;
			
			if (estaExpandidoTextoEspecialidades){
				
				findViewById(R.id.ver_mas).setVisibility(View.GONE);
				findViewById(R.id.ocultar).setVisibility(View.VISIBLE);
			} else {
				
				findViewById(R.id.ver_mas).setVisibility(View.VISIBLE);
				findViewById(R.id.ocultar).setVisibility(View.GONE);
			}
		}
	};
